            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b bg-muted">
                  <th className="sticky top-0 left-0 z-[3] bg-muted w-18 h-10 px-4 text-left align-middle font-medium text-muted-foreground whitespace-nowrap hidden sm:table-cell" />
                  <th className="sticky top-0 left-0 sm:left-18 z-[3] bg-muted w-32.5 sm:w-50 h-10 px-4 text-left align-middle font-medium text-muted-foreground whitespace-nowrap border-r border-border">{t.colName}</th>
                  <th className="sticky top-0 z-[2] bg-muted h-10 px-4 text-right align-middle font-medium text-muted-foreground whitespace-nowrap">{t.colPrice}</th>
                  <th className="sticky top-0 z-[2] bg-muted h-10 px-4 text-right align-middle font-medium text-muted-foreground whitespace-nowrap">{t.colStock}</th>
                  <th className="sticky top-0 z-[2] bg-muted h-10 px-4 text-left align-middle font-medium text-muted-foreground whitespace-nowrap">{t.colDateAdded}</th>
                  {isAdmin && <th className="sticky top-0 z-[2] bg-muted h-10 px-4 text-left align-middle font-medium text-muted-foreground whitespace-nowrap">{t.colAddedBy}</th>}
              ...
              <tbody>
                {pagedProducts.map((product) => (
                  <tr key={product.$id} className="border-b last:border-0 transition-colors hover:bg-muted/50">
                    <td className="sticky left-0 z-[1] bg-background w-18 p-2 px-4 align-middle hidden sm:table-cell">
                      {product.image_id ? (
                    ...
                    <td className="sticky left-0 sm:left-18 z-[1] bg-background w-32.5 sm:w-50 p-2 px-4 align-middle font-medium border-r border-border">
